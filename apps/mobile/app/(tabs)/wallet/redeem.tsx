...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, TextInput, KeyboardAvoidingView, Platform, Alert, ActivityIndicator, Modal, Image } from 'react-native';
    ...
    if (submitted) {
      ...
      Alert.alert(
        ...
        [
          ...
          { text: 'Batal', style: 'destructive', onPress: () => router.back() },
        ]
      );
    }
  };
    ...
    >
      {isLoading ? (
        ...
        <View style={styles.modalBackdrop}>
          <View style={[styles.bottomSheet, styles.successContainer]}>
          ...
          <View style={styles.bottomSheet}>
            ...
            >
              ...
              <View style={styles.formContainer}>
                ...
                <View style={[styles.bankInputGroup, bankMenuOpen && { zIndex: 1000, elevation: 1000 }]}>
                  <Text style={styles.inputLabel}>PILIH BANK</Text>
                  <TouchableOpacity style={styles.dropdown} onPress={() => setBankMenuOpen(!bankMenuOpen)}>
...
const styles = StyleSheet.create({
  ...
  header: { marginBottom: 24, marginTop: 10, flexDirection: 'row', alignItems: 'center' },
